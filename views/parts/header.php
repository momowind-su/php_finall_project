...
<body>
    ...
    <a class="navbar-brand" href="/?m=post&a=posts_page">Home</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="/?m=post&a=posts_page">Posts</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/?m=contact&a=contact_page">Contact</a>
            </li>
            <?php if(isset($_SESSION['user']))
                echo "<li class='nav-item'><a class='nav-link' href='/?m=user&a=show_users'>Dashboard</a></li>"
            ?>
        </ul>
